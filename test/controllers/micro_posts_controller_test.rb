...
class MicroPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micro_post" do
    assert_difference('MicroPost.count') do
      post micro_posts_url, params: { micro_post: { date: @micro_post.date, memo: @micro_post.memo, name: @micro_post.name, price: @micro_post.price } }
    end
  ...
  test "should update micro_post" do
    patch micro_post_url(@micro_post), params: { micro_post: { date: @micro_post.date, memo: @micro_post.memo, name: @micro_post.name, price: @micro_post.price } }
